...
import Countdown from "./QuizComponents/KotlinCountdown";
import Question from "./QuizComponents/KotlinQuestion";
import Results from "./QuizComponents/KotlinResults";
import QuizNav from "./QuizComponents/KotlinQuizNav";

import { kotlinQuestions } from "../../../data/KotlinQns/KotlinQuestion";
import { kotlinQuestionsOne } from "../../../data/KotlinQns/KotlinQuestionOne";
import { kotlinQuestionsTwo } from "../../../data/KotlinQns/KotlinQuestionTwo";
import { kotlinQuestionsThree } from "../../../data/KotlinQns/KotlinQuestionThree";
import { kotlinQuestionsFour } from "../../../data/KotlinQns/KotlinQuestionFour";

const allSets = [
  kotlinQuestions,
  kotlinQuestionsOne,
  kotlinQuestionsTwo,
  kotlinQuestionsThree,
  kotlinQuestionsFour,
];
...
const KotlinQuiz = () => {
  ...
  useEffect(() => {
    const savedQuiz = JSON.parse(localStorage.getItem("ongoingKotlinQuiz"));
  ...
  const handleStartQuiz = () => {
    const lastIndex = parseInt(localStorage.getItem("lastKotlinSetIndex")) || 0;
    ...
    localStorage.setItem("lastKotlinSetIndex", nextIndex);
    localStorage.setItem(
      "ongoingKotlinQuiz",
      JSON.stringify({
  ...
  const calculateScore = () => {
    ...
    localStorage.removeItem("ongoingKotlinQuiz");
