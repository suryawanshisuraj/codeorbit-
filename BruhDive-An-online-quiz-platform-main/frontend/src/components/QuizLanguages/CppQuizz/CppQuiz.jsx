...
import Countdown from "./QuizComponents/CppCountdown";
import Question from "./QuizComponents/CppQuestion";
import Results from "./QuizComponents/CppResults";
import QuizNav from "./QuizComponents/CppQuizNav";

import { cppQuestions } from "../../../data/CppQns/CppQuestion";
import { cppQuestionsOne } from "../../../data/CppQns/CppQuestionOne";
import { cppQuestionsTwo } from "../../../data/CppQns/CppQuestionTwo";
import { cppQuestionsThree } from "../../../data/CppQns/CppQuestionThree";
import { cppQuestionsFour } from "../../../data/CppQns/CppQuestionFour";
...
const CppQuiz = () => {
  ...
  useEffect(() => {
    const savedQuiz = JSON.parse(localStorage.getItem("ongoingC++Quiz"));
  ...
  const handleStartQuiz = () => {
    const lastIndex = parseInt(localStorage.getItem("lastC++SetIndex")) || 0;
    ...
    localStorage.setItem("lastC++SetIndex", nextIndex);
    localStorage.setItem(
      "ongoingC++Quiz",
      JSON.stringify({
  ...
  const calculateScore = () => {
    ...
    localStorage.removeItem("ongoingC++Quiz");
