...
import Countdown from "./QuizComponents/JsCountdown";
import Question from "./QuizComponents/JsQuestion";
import Results from "./QuizComponents/JsResults";
import QuizNav from "./QuizComponents/JsQuizNav";

import { javascriptQuestions } from "../../../data/JavascriptQns/jsQuestion";
import { javascriptQuestionsOne } from "../../../data/JavascriptQns/jsQuestionOne";
import { javascriptQuestionsTwo } from "../../../data/JavascriptQns/jsQuestionTwo";
import { javascriptQuestionsThree } from "../../../data/JavascriptQns/jsQuestionThree";
import { javascriptQuestionsFour } from "../../../data/JavascriptQns/jsQuestionFour";

const allSets = [
  javascriptQuestions,
  javascriptQuestionsOne,
  javascriptQuestionsTwo,
  javascriptQuestionsThree,
  javascriptQuestionsFour,
];
...
const JavascriptQuiz = () => {
  ...
  useEffect(() => {
    const savedQuiz = JSON.parse(localStorage.getItem("ongoingJavascriptQuiz"));
  ...
  const handleStartQuiz = () => {
    const lastIndex =
      parseInt(localStorage.getItem("lastJavascriptSetIndex")) || 0;
    ...
    localStorage.setItem("lastJavascriptSetIndex", nextIndex);
    localStorage.setItem(
      "ongoingJavascriptQuiz",
      JSON.stringify({
  ...
  const calculateScore = () => {
    ...
    localStorage.removeItem("ongoingJavascriptQuiz");

    localStorage.setItem(
      "javascriptQuizResult",
      JSON.stringify({
