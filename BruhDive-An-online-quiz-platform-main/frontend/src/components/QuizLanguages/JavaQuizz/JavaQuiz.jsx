...
import Countdown from "./QuizComponents/JavaCountdown";
import Question from "./QuizComponents/JavaQuestion";
import Results from "./QuizComponents/JavaResults";
import QuizNav from "./QuizComponents/JavaQuizNav";

import { javaQuestions } from "../../../data/JavaQns/JavaQuestion";
import { javaQuestionsOne } from "../../../data/JavaQns/JavaQuestionOne";
import { javaQuestionsTwo } from "../../../data/JavaQns/JavaQuestionTwo";
import { javaQuestionsThree } from "../../../data/JavaQns/JavaQuestionThree";
import { javaQuestionsFour } from "../../../data/JavaQns/JavaQuestionFour";
...
const JavaQuiz = () => {
  ...
  useEffect(() => {
    const savedQuiz = JSON.parse(localStorage.getItem("ongoingJavaQuiz"));
  ...
  const handleStartQuiz = () => {
    const lastIndex = parseInt(localStorage.getItem("lastJavaSetIndex")) || 0;
    ...
    localStorage.setItem("lastJavaSetIndex", nextIndex);
    localStorage.setItem(
      "ongoingJavaQuiz",
      JSON.stringify({
  ...
  const calculateScore = () => {
    ...
    localStorage.removeItem("ongoingJavaQuiz");
